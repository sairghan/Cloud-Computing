...
public class Accesspart22
{
    public static void pathfinder( String filename )
    {
        ...
        JavaPairRDD<Integer, String> filter = sort.filter(action-> action.equals("/assets/js/lowpro.js"));
    ...
    public static void pathfinder2( String filename )
    {
        SparkConf conf = new SparkConf().setMaster("yarn").setAppName("AccessLog3");
        ...
        JavaPairRDD<Integer, String> filter = sort.filter(action-> action.equals("/favicon.ico"));
